...
local CREDITS = {
	...
	--'|cff82B4ffEltreum|r - Programming',
	--'Blazeflack -- Plugin Installer',
	--'and many more!',
}
...
local InstallerData = {
	...
	Pages = {
		...
		[2] = function()
			...
			PluginInstallFrame.Desc2:SetText("This is line 2, replace with any text, just like you can replace line 1")
