...
function JiberishUI:JiberishPortraitMode()
	...
	E.db["unitframe"]["units"]["party"]["customTexts"]["[name:eltruism:gradient]"]["size"] = 16
	...
	E.db["unitframe"]["units"]["player"]["customTexts"]["[name:eltruism:gradient]"]["size"] = 20
	...
	E.db["unitframe"]["units"]["target"]["customTexts"]["[name:eltruism:gradient]"]["size"] = 20
	...
	E.db["unitframe"]["units"]["target"]["customTexts"]["[name:eltruism:gradient]"]["yOffset"] = 24
	...
	E.db["unitframe"]["units"]["targettarget"]["customTexts"]["[name:eltruism:gradient]"]["size"] = 13
	...
	E.db["unitframe"]["units"]["targettarget"]["customTexts"]["[name:eltruism:gradient]"]["yOffset"] = 19
