...
function JiberishUI:JiberishMidnight()
	...
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["attachTextTo"] = "Health"
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["enable"] = true
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["font"] = "KMT-GothamXN_Ultra"
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["fontOutline"] = "OUTLINE"
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["justifyH"] = "LEFT"
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["size"] = 35
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["text_format"] = "[eltruism:ReleafBorder:all]"
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["xOffset"] = -5
	E.db["unitframe"]["units"]["player"]["customTexts"]["JiberishIcon"]["yOffset"] = 0
